      ...
      chrome.runtime.sendMessage(
        ...
        (response) => {
          ...
          if (confidence < 0.35) {
            ...
            confidenceFill.style.background = "linear-gradient(90deg, #00ff88, #00ccff)";
          ...
          desyncValue.className = desyncPct > 50 ? "metric-value danger" : desyncPct > 25 ? "metric-value warning" : "metric-value safe";
      ...
      chrome.runtime.sendMessage(
        ...
        (response) => {
          if (response?.status === "download_initiated") {
            ...
            addLog(`PDF export failed: ${response?.message || "Unknown error"}`, "danger");
          }
        }
      );
    });
